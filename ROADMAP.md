...
| :--- | :--- | :--- | :---: | :---: |
| **1.1 Rate Limiting Engines** | Token Bucket, Leaky Bucket, Sliding Window Log, Sliding Window Counter | Cloudflare API Shield, Stripe API Limiter | ⏳ Planned | Easy-Medium |
...
| PoC | Core Problem / Algorithm | Real-World Analog | Status | Difficulty |
| :--- | :--- | :--- | :---: | :---: |
| **2.1 Consistent Hashing Ring** | MD5/SHA hash ring, Virtual Nodes (vnodes), Minimal key migration on churn | Amazon DynamoDB, Apache Cassandra, Discord Cache | ⏳ Planned | Medium |
